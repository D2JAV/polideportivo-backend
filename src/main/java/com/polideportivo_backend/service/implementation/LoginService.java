...
public class LoginService extends GenericService<Login, Integer> implements ILoginService {

    private final IGenericRepository<Login, Integer> repo;

    @Override
    protected IGenericRepository<Login, Integer> getRepo() {
        return repo;
    }

    @Override
    public Login validAndSave(Login login) {
        // Implementación específica similar a PatientService
        return null;
    }

    @Override
    public Login update(Integer t, ReservaDTO id) throws Exception {
        return null;
    }
