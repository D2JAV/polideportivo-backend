...
public class DataLoader implements CommandLineRunner {
    ...
    private void cargarCampos() {
        if (campoRepository.count() == 0) {
            ...
            campoFutbol1.setDescripcion("Cancha de fútbol de 7 personas");
